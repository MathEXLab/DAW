...
def compute_distributed_time(
	...
	# check return_exp_test is true in kwargs
	return_exp_test = kwargs.get('return_exp_test',False)
	...
	if return_exp_test:
		exp_test_results  = res['H0']
		exp_test_results = comm.gather(exp_test_results, root=0)
